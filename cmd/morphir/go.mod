module github.com/finos/morphir-go/cmd/morphir
...
require (
	...
	github.com/finos/morphir-go/pkg/logging v0.4.0-alpha.4
	...
	github.com/finos/morphir-go/pkg/tooling v0.4.0-alpha.4
...
require (
	...
	github.com/finos/morphir-go/pkg/bindings/typemap v0.4.0-alpha.4 // indirect
